...
public class SendPDF {
	...
	public final void init(String filePath1,String BGImage1,String UserName1,String CouponId1,
			String Date1,String ApartmentName1,String SchoolName1,String ApartmentDiscount1){
		...
		ApartmentDiscount=ApartmentDiscount1;
	}
 ...
 public final void writeCharpter() throws Exception {
  ...
  Document document = new Document(new Rectangle(900,372), 20, 20, 20, 20);
