...
public class WebController{
	...
	public String setwebstate(String state,HttpServletRequest request,HttpSession session){
		if("cn".equals(state)){
			session.setAttribute("WebLanguageVersion","cn");
			return "redirect:/others/index.html";
		}else if("fa".equals(state)){
			session.setAttribute("WebLanguageVersion","fa");
			return "redirect:/others/index.html";
		}else{
			session.setAttribute("WebLanguageVersion","en");
			return "redirect:/index.html";
		}
	}

	@RequestMapping("head")
	public void head(HttpSession session){
