...
var Default_isFT = 1		//默認是否繁體，0-簡體，1-繁體
...
function StranText(txt,toFT,chgTxt)
{
	...
	if(chgTxt)txt=txt.replace((toFT?"繁":"簡"),(toFT?"簡":"繁"))
...
//判断简繁字体---t=true||||f=false   !
if($("#WebLanguageVersion").val()=="fa")
	StranBody();
