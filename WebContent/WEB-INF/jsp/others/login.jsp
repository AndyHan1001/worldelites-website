...
<form action="<%=path2 %>/others/loginSuccess.html" method="get" name="from1" id="form1" target="_parent">
  <table width="540" border="0" align="left" cellpadding="0" cellspacing="0" style="font-size:12px;">
    <tr>
      ...
      <table align="center" width="280">
        <tr>
          <td width="60" height="35" style="font-size:13px;">邮箱 </td>
          <td><input name="mail" id="mail" style="width:150px;"/></td>
        </tr>
        <tr>
          <td height="35" style="font-size:13px;">密码 </td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td>
          	<input type="button" class="submit" onclick="login()" value="登录" />
          	<script>
          		function login(){
            ...
            <input type="reset" class="reset" value="重新填写" /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td>&nbsp;</td>
          <td style="font-size:12px;"><a href="../reg.html?act=regdo" target="_parent">注册新账户</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="../resetpassword.html" target="_self">忘记密码？</a></td>
        </tr>
      </table>
      </td>
