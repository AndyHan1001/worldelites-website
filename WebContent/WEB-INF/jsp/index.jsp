...
<div class="FrameBanner">
		...
		<div class="SearchForm">
			<form action="apartment/university.html" method="post">
              ...
              <!--<input type="image"  class="inputSearch" src="<%= path2 %>/resources/web/images/SearchButton.jpg" />-->
...
<div class="FrameProcess">
    <div class="divProcessBody">
		<img src="<%= path2 %>/resources/web/images/channel.jpg">
    </div>
</div>
...
<div class="FrameProduct">
	<div class="divProduct">
    	<div class="divProductLeft">
        	<div class="dplHead">
            	Featured Apartments
                <p><a href="apartment/university.html"></a></p>
            </div>
            <div class="dplMain">
			  <script>
                $(function () {
	...
	<div class="img-scroll">
		<div class="scroll img-list" id="content_content">
			<ul id="pic_url"  class="list_main_big" style="margin-left: 0px;">
                    ...
                    <li>
                    <div class="pic"><a href="<%=path  %>/university/${item.memo}/${fn:replace(item.name,' ','_')}"><img src="<%= path2 %>/fileupload/images/${item.logo}" /></a></div>
                    <div class="bg"></div>
                    <div class="text">
                      ...
                      <div class="PrdtMc"  style="margin-left:5px;"><a href="<%=path  %>/university/${item.memo}/${fn:replace(item.name,' ','_')}">${item.name}</a></div>
                      <div class="PrdtDx"  style="margin-left:5px;"><a href="<%=path  %>/university/${item.memo}">${item.parentname}</a></div>
                    </div>
          ...
          <div class="dplMain">
            ...
            <li>
            	<dl>
                    ...
                    <dd class="info">
                        <a href="<%=path  %>/university/${item.memo}/${fn:replace(item.name,' ','_')}"><c:out value="${item.name}"></c:out></a>
                    </dd>
...
<div class="FrameMap">
    <div class="divMapHead">
    	<img src="<%= path2 %>/resources/web/images/tit_map.jpg">
    </div>
	...
	<div class="divMapShow">
        ...
        <div class="divMapRight">
           <div class="divMapRight">
              <iframe style="float:right; width:800px; height:500px;" allowtransparency="true" frameborder="0" scrolling="no" src="<%= path%>/resources/MapDiv.html"></iframe>
        </div>
        </div>
	</div>
</div>
...
<div class="FrameCases">
    <div class="divCasesHead">
    	<img src="<%= path2 %>/resources/web/images/tit_blog.jpg">
    </div>
    <div class="divCasesList">
    	<div class="divCaseListDot2">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[0].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[0].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[0].id}"><c:out value="${allthread15[0].title}"></c:out></a></div>
        </div>

        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[1].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[1].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[1].id}"><c:out value="${allthread15[1].title}"></c:out></a></div>
        </div>
        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[2].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[2].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[2].id}"><c:out value="${allthread15[2].title}"></c:out></a></div>
        </div>

        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[3].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[3].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[3].id}"><c:out value="${allthread15[3].title}"></c:out></a></div>
        </div>

        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[4].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[4].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[4].id}"><c:out value="${allthread15[4].title}"></c:out></a></div>
        </div>

        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[5].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[5].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[5].id}"><c:out value="${allthread15[5].title}"></c:out></a></div>
        </div>

        <div class="divCaseListDot">
	        <div class="CaseTp"><a href="bbs/bbsshow.html?id=${allthread15[6].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[6].logo}" /></a></div>
            <div class="CaseMc"></div>
            <div class="CaseJg"><a href="bbs/bbsshow.html?id=${allthread15[6].id}"><c:out value="${allthread15[6].title}"></c:out></a></div>
        </div>
    ...
    <div class="divCasesList">
    	<div class="community1">
            <dl>
                ...
                <dd><a href="bbs/bbsshow.html?id=${allthread15[7].id}">${allthread15[7].title}</a></dd>
            ...
            <dl>
                ...
                <dd><a href="bbs/bbsshow.html?id=${allthread15[8].id}">${allthread15[8].title}</a></dd>
            ...
            <dl>
                ...
                <dd><a href="bbs/bbsshow.html?id=${allthread15[9].id}">${allthread15[9].title}</a></dd>
    	...
    	<div class="community2">
	        <div class="BbsTp"><a href="bbs/bbsshow.html?id=${allthread15[10].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[10].logo}" /></a></div>
            <div class="BbsMc"><a href="bbs/bbsshow.html?id=${allthread15[10].id}"><c:out value="${allthread15[10].title}"></c:out></a></div>
        </div>
    	<div class="community3">
            <dl>
                <dt><img src="<%= path2 %>/fileupload/images/${allthread15[11].logo}" width="90" height="65"  /></dt>
                <dd><a href="bbs/bbsshow.html?id=${allthread15[11].id}"><c:out value="${allthread15[11].title}"></c:out></a></dd>
            ...
            <dl>
                ...
                <dd><a href="bbs/bbsshow.html?id=${allthread15[12].id}"><c:out value="${allthread15[12].title}"></c:out></a></dd>
            ...
            <dl>
                ...
                <dd><a href="bbs/bbsshow.html?id=${allthread15[13].id}"><c:out value="${allthread15[13].title}"></c:out></a></dd>
    	...
    	<div class="community4">
	        <div class="BbsTp"><a href="bbs/bbsshow.html?id=${allthread15[14].id}"><img src="<%= path2 %>/fileupload/images/${allthread15[14].logo}" /></a></div>
            <div class="BbsMc"><a href="bbs/bbsshow.html?id=${allthread15[14].id}"><c:out value="${allthread15[14].title}"></c:out></a></div>
        </div>
	</div>	
</div>
...
<script language="javascript">
	...
	showPopWin('<%= path %>/resetpassword.html', 550, 290, null);
			}
</script>
</c:if>
<c:if test="${act=='login'}">
