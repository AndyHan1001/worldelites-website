    ...
    <div class="order" style="width:100%">
          ...
          <%
            ...
            <div class="order_content2">
                ...
                <!-- 公寓信息 -->
                <tr>
                  <td colspan="4" align="left" bgcolor="#fafafa"  style="width:100%;border-bottom:2px solid #F5AA00;color:#F5AA00;">Apartment Infomation</td>
                </tr>
                <tr>
                  ...
                  <td colspan="4" align="left">
	                  <table width="880" border="0" align="center" cellpadding="0" cellspacing="0">
	                    <tr>
	                             ...
	                             <td align="left" width="190">
	                                	 ${(oneroom.info==null||oneroom.info=='')?"":oneroom.info}
	                             </td>
           ...
           <!--  <div class="order_title"><span left-pos="0|12" right-pos="0|12" space="">Read the terms</span></div>
            ...
            <div class="order_submit">
                    <div class="s_submit">
                       <%--  <p><a href="<%=path %>/order_cn/order_userinfo.html?roomid=${oneroom.id}&apartmentid=${oneapartment.id}&enterlong="  class="sbt">Prev</a></p> --%>
