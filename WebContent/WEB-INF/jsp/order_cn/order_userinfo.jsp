              ...
              <table width="100%" border="0" cellpadding="5" align="center">
                ...
                <tr>
                 ...
                 <td colspan="3">
                  ...
                  <iframe id="ff3" name="fff"  src="<%=request.getContextPath()+"/upload/uploadfile3.html"%>" frameborder="0" scrolling="no" width="610" height="30" style="background-color:#ffffff; margin:0; padding:0; "></iframe>
                  </td>
                </tr>
                <tr>
                  <td><p >Others:</p></td>
                 <td colspan="3">
                  ...
                  <iframe id="ff4" name="fff"  src="<%=request.getContextPath()+"/upload/uploadfile4.html"%>" frameborder="0" scrolling="no" width="610" height="30" style="background-color:#ffffff; margin:0; padding:0; "></iframe>
                  </td>
                </tr>
              </table>
            </form>
