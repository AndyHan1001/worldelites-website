...
<div class="FrameMap" style="background:white">
	<div class="divMapShow" style="background:white">
        ...
        <div class="divMapRight">
              <iframe style="float:left; width:800px; height:500px;" frameborder="0" scrolling="no" src="<%=path2 %>/resources-cn/MapDiv.html"></iframe>
      </div>
            ...
            <div class="dplMain">          
                ...
                <dl class="UniversityList">
                    ...
                    <dd>
                        ...
                        <p><a href="<%=path %>/university_cn/${item2.memo}"><c:out value="${item2.name}"></c:out></a></p>
                        </c:forEach>
                    </dd>
                </dl>
                </c:forEach>
