...
<div class="FrameUniversity">
    ...
    <div class="order">
            ...
            <ul>
                ...
                <div class="pic"><a href="<%=path  %>/university_cn/${oneapartment.memo}/${fn:replace(oneapartment.name,' ','_')}"><img src="<%= path2 %>/fileupload/images/${oneapartment.logo}" /></a></div>
                <div class="text">
                  <h2>
                  <a href="<%=path  %>/university_cn/${oneapartment.memo}/${fn:replace(oneapartment.name,' ','_')}">${oneapartment.name}</a>
...
-->               <p>&nbsp;</p>
                 ...
                 <div class="s_submit">
                     <p><a href="javascript:download(${oneapartment.id})"  class="sbt">下载Coupon</a></p>
                 </div>
                </div>
              </li>
                    ...
                    <div class="su_rt_1">
                      ...
                      <div class="s_btn">
                        ...
                        <c:if test="${oneapartment.isbook==1}">
							  <p><a href="../order_cn/order.html?apartmentid=${oneapartment.id}" class="yd">预定该公寓</a></p>
                        </c:if>
                        <c:if test="${oneapartment.isbook!=1}">
							  <p><a href="###" class="yd" style="background:#CCC;">预定该公寓</a></p> 	
                        </c:if>
                   ...
                   <c:if test="${othersapartmentlist!=null&&othersapartmentlist!=''}">
                    <div class="su_rt_1">
                            ...
                            <div class="su_main">
                                ...
                                <li>
                                    <dl>
                                        <dd class="pic"><a href="../apartment_cn/apartment.html?id=${item.id}"><img src="<%= path2 %>/fileupload/images/${item.logo}" /></a></dd>
                                        <dd class="info">
                                            <h1><a href="../apartment_cn/apartment.html?id=${item.id}"><c:out value="${item.name}"></c:out></a></h1>
                                            <p><a href="../apartment_cn/apartment.html?id=${item.id}"><c:out value="${item.memo}"></c:out></a></p>
                                        </dd>
