		...
		<div id="regDiv3">
         <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
               <tr>
                 ...
                 <p>&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#000">1：Account Information</span>&nbsp;&nbsp;->&nbsp;&nbsp;<span style="color:#000">2：Account Activation</span>&nbsp;&nbsp;->&nbsp;&nbsp;<span style="color:#F6AB00">3：Welcome to WE</span></p><hr /></td>
             </tr>
               <tr>
...
you can tour around and find out the best housing option.！</p>
                 <br>
                 <p><input type="button" class="submit" value="Log in to my account" onClick="showPopWin('<%= path %>/login.html', 550, 290, null);"></p>
                 </td>
               </tr>
             </table>
             <br>
