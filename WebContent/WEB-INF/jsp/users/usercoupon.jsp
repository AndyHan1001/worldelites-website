        	...
        	<div class="MainLeftMenu">
                ...
                <div class="dplMain">
                    <ul>
                        ...
                        <li id="hoverNew"><a href="usercoupon.html" >My Coupon</a></li>                        
        ...
        <div class="MainRight">
			<h4><p>My Coupon</p></h4>
				...
				<table width="800" style="border-bottom:4px solid #AAC22C; margin-bottom:15px;">
				  ...
				  <tr class="clocr0CC">
				    <td height="85" rowspan="2"><a href="<%=path %>/university/${item.coupon.schoolname}/${fn:replace(item.coupon.apartmentname,' ','_')}">
				    ...
				    <td><a href="<%=path %>/university/${item.coupon.schoolname}/${fn:replace(item.coupon.apartmentname,' ','_')}">${item.coupon.apartmentname}</a></td>
			      </tr>
				  <tr height="10" >
