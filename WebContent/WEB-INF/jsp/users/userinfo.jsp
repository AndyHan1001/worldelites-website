	...
	<div class="divMain">
        <div class="MainLeft">
        	<div class="MainLeftMenu">
                ...
                <div class="dplMain">
                    <ul>
                        <li id="hoverNew" ><a href="userinfo.html" >My Profile</a></li>
        ...
        <div class="MainRight">
			<h4><p>My Profile<input type="button" id="editbutton" class="editbutton" onClick="showInput()" value="Edit" /></p></h4>
		  <form action="updateuserinfo.html" name="userinfoform" method="post">
		    <table width="800" border="0" cellpadding="5" align="center">
		      <!-- 个人信息 -->
		      <tr>
		        <td colspan="4" align="left"  bgcolor="#FAFAFA" style="border-bottom:1px solid #ABC138; height:30px;color:#F7AB00"><p  style="color:#F90">Personal&nbsp;Information</p></td>
	          </tr>
		      ...
		      <!-- 学校信息 -->
		      <tr>
		        <td colspan="4" align="left"  bgcolor="#FAFAFA" style="border-bottom:1px solid #ABC138; height:30px;color:#F7AB00"><p  style="color:#F90">University Infomation</p></td>
	          </tr>
		      <tr>
		      ...
		      <!-- 联系方式  -->
		      <tr>
		        <td colspan="4" align="left"  bgcolor="#FAFAFA" style="border-bottom:1px solid #ABC138; height:30px;color:#F7AB00"><p  style="color:#F90">Contact&nbsp;information</p></td>
	          </tr>
		      <tr>
		      ...
		      <!-- 紧急情况联系人 -->
		      <tr>
		        <td colspan="4" align="left"  bgcolor="#FAFAFA" style="border-bottom:1px solid #ABC138; height:30px;color:#F7AB00"><p  style="color:#F90">Emergency&nbsp;Contact&nbsp;Information</p></td>
	          </tr>
		      <tr>
		        <td><p >*Full Name:</p></td>
		        <td>
		      ...
		      <tr>
		        <td colspan="4" align="left"  bgcolor="#FAFAFA" style="border-bottom:1px solid #ABC138; height:30px;color:#F7AB00"><p  style="color:#F90">Roommate Information, If Any</p></td>
	          </tr>
		      <tr>
