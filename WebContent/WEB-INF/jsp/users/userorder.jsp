...
<div class="FrameMain">
	<div class="divMain">
        	...
        	<div class="MainLeftMenu">
                ...
                <div class="dplMain">
                    <ul>
                        ...
                        <li id="hoverNew"><a href="userorder.html" >My Bookings</a></li>
                    </ul>
                </div>
            </div>
        ...
        <div class="MainRight">
			<h4><p>My Bookings</p></h4>
			<div class="myThreads">
				<c:forEach var="item" items="${orderlist}">
				  <table width="800" style="border:4px solid #AAC22C; margin-bottom:15px;">
				  	<tr><td colspan="5" height="8"></td></tr>
				    <tr>
				      <td colspan="3">&nbsp;&nbsp;Booking : <a href="javascript:void(0)">${item.orderid}</a></td>
				    ...
				    <tr class="clocr0CC">
				      <td height="85" rowspan="3">&nbsp;<a target="_blank" href="<%=path %>/university/${item.schoolname}/${fn:replace(item.apartmentname,' ','_')}">
				      																		 <img src="<%=path %>/fileupload/images/${item.logo}" width="120" height="80" /></a></td>
				      <td>Apartment Name</td>
				      <td colspan="3" ><a href="<%=path %>/university/${item.schoolname}/${fn:replace(item.apartmentname,' ','_')}"  target="_blank">${item.apartmentname}</a></td>
			        </tr>
				    <tr class="clocr0CC">
				      <td>Floor Plan</td>
				      <td colspan="3"><a href="<%=path %>/university/${item.schoolname}/${fn:replace(item.apartmentname,' ','_')}" target="_blank">${item.roomname}</a></td>
			        </tr>
         		...
         		<script type="text/javascript">
         			/* $(function(){
         				$(".listOfCost_bt").each(function(i){
         					$(this).click(function(){
             					if($(".listOfCost").eq(i).is(":hidden")){
             						$(".listOfCost").eq(i).show();
             					}else{
             						$(".listOfCost").eq(i).hide();
             					}
         					});
         				});
