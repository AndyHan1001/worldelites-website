...
var gLoading = "/resources/web/subDiv2/loading.html";
	...
	popcont.innerHTML = '' +
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'</div>' +
			'</div>' +
			'<iframe src="'+gLoading+'" style="width:670px;height:400px;background-color:transparent;" scrolling="no" frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="670" height="400"></iframe>' +
		'</div>';
