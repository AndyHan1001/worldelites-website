...
var gLoading = "/worldelites/resources/web/subDiv/loading.html";
	...
	popcont.innerHTML = '' +
		'<div id="popupInner">' +
			'<div id="popupTitleBar">' +
				...
				'</div>' +
			'</div>' +
			'<iframe src="'+gLoading+'" style="width:530px;height:330px;background-color:transparent;" scrolling="no" frameborder="0" allowtransparency="true" id="popupFrame" name="popupFrame" width="530" height="330"></iframe>' +
		'</div>';
...
function showPopWin(url, width, height, returnFunc) {
	...
	window.setTimeout("setPopTitleAndRewriteTargets();", 20);
}
